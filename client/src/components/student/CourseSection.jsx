...
const CourseSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <div className='grid [grid-template-columns:repeat(auto-fit,minmax(200px,1fr))]  px-4 md:px-0 md:my-16 my-10 gap-4' >{allCourses.slice(0,4).map((course,index)=><CourseCard key={index} course={course}/>)}</div>
