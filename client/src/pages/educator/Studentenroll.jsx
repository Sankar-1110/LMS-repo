...
const Studentenroll = () => {
  ...
  return enrolledStudents? (
    <div className='min-h-screen flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pb-0'>
      <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gary-500/20'>
      <table className='table-fixed md:table-auto w-full overflow-hidden pb-4'>
        ...
        {enrolledStudents.map((item,index)=>(
          <tr key={index} className='border-b border-gray-500/20'>
            ...
            <td className='md:px-4 py-3 flex items-ce
            nter space-x-3'>
