...
console.log('f2: ',filteredCourse);
  ...
  return (
    <>
    <div className='relative md:px-36 px-8 pt-29 text-left'><div className='flex md:flex-row flex-col gap-6 items-start justify-between w-full'>
      <div>
    ...
    </div>{input && <div className='inline-flex items-center gap-4 px-4 py-2 border mt-8 -mb-8 text-gray-600'>
      <p>{input}</p>
