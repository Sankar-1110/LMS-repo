...
export const deleteCourse = async (req, res) => {
  try {
    const { id } = req.params
    const { userId } = req.auth()            // use req.auth() as a function
    ...
    // delete via model method to avoid "remove is not a function"
...
export const getEducatorCourse = async (req, res) => {
  try {
    const educator = req.auth().userId    // use req.auth() as a function
